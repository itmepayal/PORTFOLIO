  ...
  return (
    <Container>
      ...
      <Dialog open={openSuccessModal} onOpenChange={setOpenSuccessModal}>
        <DialogContent className=" overflow-hidden border-border/50 bg-background/95 backdrop-blur-2xl max-w-xl! rounded-4xl p-0 shadow-2xl">
          ...
          <div className="relative z-10 p-8 sm:p-10">
            <DialogHeader className="space-y-5">
              ...
              <div className=" rounded-3xl border border-border bg-muted/40 p-5 text-left">
