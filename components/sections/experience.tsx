          ...
          <div className="relative mt-6 sm:mt-10">
            ...
            {loading ? (
              ...
              experiences.map((item, i) => (
                <Link href={`/experiences/${item._id}`} className="block">
                  <motion.div
                    key={i}
                    initial={{
                      opacity: 0,
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-2 gap-3 mt-3">
                                <a
                                  ...
                                  className="inline-flex items-center justify-center md:justify-start gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-2 text-sm font-semibold text-primary transition-all duration-300 hover:bg-primary/10 hover:border-primary/40"
                                >
                                ...
                                <div className="inline-flex items-center justify-center md:justify-start gap-2 rounded-full border border-border bg-muted/40 px-4 py-2">
                                  <MapPin size={12} />
