...
export const ProfileCard = () => {
  ...
  return (
    <div className="flex justify-center min-h-screen px-3 py-3.5">
      <motion.div
        initial={{ opacity: 0, y: 40, scale: 0.95 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        className="relative w-full max-w-sm rounded-[28px]"
      >
        {/* Glow */}
        <div className="absolute inset-0 blur-2xl opacity-30 rounded-[28px]" />

        <div className="relative rounded-[28px] backdrop-blur-2xl border border-border px-6 py-6 space-y-5">
          {/* PROFILE */}
          <div className="text-center space-y-2.5">
            ...
            <div className="flex justify-center gap-2 flex-wrap">
              <Badge className="text-xs bg-card text-white px-3 py-1">
            ...
            <p className="flex items-center justify-center gap-1 text-gray-400">
              ...
              <span className="text-sm text-white">MCA • Computer Science</span>
            </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {TECH_STACK.map(({ name, icon: Icon }) => (
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center gap-1 p-3 rounded-xl border border-border text-xs text-center"
                >
